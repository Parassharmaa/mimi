...
for appearance in light dark; do
  for screen in menu transcript onboarding captions settings-models settings-capture settings-privacy settings-captions; do
