...
for scenario in "menu ready" "menu recording" "menu backpressure" "menu failed" "menu clear-confirmation" "menu follow-latest-paused" "transcript ready" "transcript recording" "transcript backpressure" "transcript clear-confirmation" "transcript follow-latest-paused" "transcript incremental-translation" "transcript translation-stream" "onboarding welcome" "onboarding model-preparing" "onboarding model-ready" "onboarding model-failed" "onboarding ready" "onboarding voice-enabled" "captions ready" "captions caption-stream" "voice-typing ready" "settings-models ready" "settings-capture ready" "settings-privacy ready" "settings-captions ready" "settings-voice ready" "settings-voice voice-enabled"; do
